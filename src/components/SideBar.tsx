...
export default function SideBar() {
    return (
        <nav className="flex sm:flex-col sm:w-80 sm:p-5 sm:shadow-none shadow bg-card max-sm:sticky z-50 max-sm:bottom-0">
            ...
            <LazyLoadImage src="/images/logo.png" className='w-16' alt="World Explorer App Logo" />
